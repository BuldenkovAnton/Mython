...
namespace runtime {
    ...
    template <typename T>
    class ValueObject : public Object { //думаю что реализован
    public:
    ...
    class Executable { //думаю что реализован
    public:
    ...
    // Класс
    class Class : public Object { //готово
    public:
    ...
    // Экземпляр класса
    class ClassInstance : public Object { //готово
    public:
